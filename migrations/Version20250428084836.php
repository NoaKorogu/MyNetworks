 ...
 */
final class Version20250428084836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE path (id SERIAL NOT NULL, network_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, color VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B548B0F34128B91 ON path (network_id)');
        $this->addSql('CREATE TABLE structure (id SERIAL NOT NULL, network_id INT NOT NULL, type_id INT NOT NULL, name VARCHAR(128) NOT NULL, location VARCHAR(255) NOT NULL, discriminator VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
